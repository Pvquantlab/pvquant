...
## 6. MERKAS ile Kıyaslama

Model dokümantasyonu (`PVQuant_Model_Mantigi_v2.docx`) MERKAS santralı için
...
- Sadece bir öğle penceresi (10:00-14:00) MERKAS başarısı için yeterli olurdu
...
Faz 1.7 **ikincil hedefine ulaşamadı**: gerçek dünyada Mod B kalibrasyonun MERKAS
...
MERKAS seviyesine yaklaşması bekleniyor.
