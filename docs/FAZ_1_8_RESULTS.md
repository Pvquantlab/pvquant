...
- azimuth=140° → MAPE %28, sapma %0.15 (referans santral seviyesi)
...
**Referans santral kıyaslaması:** Yıllık sapma %0.77. FSA_1 Faz 1.8'de yaz için %0.00
sapma — referans santralden iyi.
...
1. **Kalibrasyon artık gerçek dünyada çalışıyor.** FSA_1 yaz için sapma %0,
   MAPE %20 — referans santral seviyesine ulaştık ve geçtik.
