...
BOZUKLAR = [
    ...
    ("bozuk_12_kunye_d26.json", "D26", False),
]
_sayac = [0]
...
BEKLENEN_KODLAR = ["D%d" % i for i in range(1, 27)]   # D1..D26
BEKLENEN_GECEN_KAYIT = 37                             # kanonik koşuda geçen kayıt sayısı (D22 +3, D23 +2, D24 +3, D25 +3, D26 +1)
